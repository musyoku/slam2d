...
void main(){
    ...
    void Observer::render(GLFWwindow* window, int x, int y, int width, int height, glm::vec4* observed_values, int num_observation)
    {
        ...
        glDrawArrays(GL_LINE_LOOP, 0, num_observation);
